CREATE OR REPLACE MACRO audit.check_consumer_005(epoch_start, epoch_end) AS TABLE
  ...
  WHERE cr.epoch BETWEEN epoch_start AND epoch_end
    ...
    AND cr.delivered_stream_seq > sl.last_seq
    AND sl.last_seq > 0;
